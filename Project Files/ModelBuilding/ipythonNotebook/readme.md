<p>In this folder i am uploading the jupyter notebook which is when executed results in different models which can be saved by you and you can load them back for doing predictions</p>
